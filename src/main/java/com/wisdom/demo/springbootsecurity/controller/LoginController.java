...
import com.wisdom.demo.springbootsecurity.util.ConstantVal;
...
public class LoginController {
    ...
    public String userLogin(HttpServletRequest request) {
        ...
        String s = request.getSession().getAttribute(ConstantVal.CHECK_CODE.toString()).toString();
    ...
    public ReturnMessage applyCheckCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //保存到session
        request.getSession().setAttribute(ConstantVal.CHECK_CODE.toString(), text);
